    ...
    const Appoinment = () => {
                          ...
                          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px">
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px">
                                          <tr>
                                            <td width="100%" align="center" style="font-family:Open Sans,Helvetica,Arial,sans-serif;font-size:16px;font-weight:800;line-height:24px;padding:10px">
                                              <a href="tel:+91 986745454" style="text-decoration:none;color:#000;font-family:serif;font-size:16px">Mordern Towing</a>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px">
                                          <tr>
                                            <td width="100%" align="center" style="font-family:Open Sans,Helvetica,Arial,sans-serif;font-weight:800">
                                              <img style="width:100%;height:120px" src="http://localhost:3000/static/media/logo.a5c2c85d0c85f099c54c.png" alt="">
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                                    ...
                                    <td width="100%" align="center" valign="top" style="font-size:0">
                                      <div style="display:inline-block;max-width:50%;min-width:240px;vertical-align:top;text-align:center;width:100%">
                                        ...
                                        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="max-width:300px">
                                          <tr>
                                            <td width="100%" align="left" valign="top" style="font-family:Open Sans,Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:24px">
                                              <p style="font-size:16px;font-weight:600;color:#0074be">Customer Last Name:</p>
                                              <p style="font-size:14px;font-weight:500;color:#111">${custLastName}</p>
                                            </td>
                                          </tr>
                                        </table>
                                      </div>
                            ...
                            <tr>
                              <td width="100%" align="center" bgcolor="#FFD44C" style="padding:10px 0">
                                <p style="color:#000;font-weight:500;font-size:1rem;padding:0;margin:0">Mordern Towing</p>
                              </td>
                            </tr>
                          </table>
                        </td>
        ...
        fetch("https://skdm.in/server/v1/send_lead_mail.php", {
          ...
          body: new URLSearchParams({
            ...
            bccMail: "mukundsharma1085@gmail.com",
            mailSubject: "New Customer Lead",
            mailBody: body,
            accountName: "Mordern Towing",
            accountLeadSource: "https://demo.com/",
                    ...
                    <div className="col-md-8 to_animate animated scaleAppear" data-animation="scaleAppear">
                        ...
                        <form className="contact-form" onSubmit={handleSubmit}>
                            ...
                            <p className="form-submit">
                                <button type="submit" className="theme_button">Send message</button>
                            </p>
                        </form>
                    </div>
                    {/* Contact Info */}
